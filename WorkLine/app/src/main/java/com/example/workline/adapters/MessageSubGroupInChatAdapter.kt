...
class MessageSubGroupInChatAdapter (val messages: MutableList<MessageSubGroup>) :
    RecyclerView.Adapter<MessageSubGroupInChatAdapter.ViewHolder>() {

    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {

        fun setData(message: MessageSubGroup) {
